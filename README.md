...
<br>Content tracking system **FastAPI**, **Celery**, **SQLAlchemy**<br>BookStore API — async SQLAlchemy 2.0, Alembic migrations, role-based access, and full pytest coverage<br><br><br>💫 About Me<br><br>🔭 Currently focused on FastAPI, async systems, and distributed task processing<br>🛠️ Building real-world projects covering auth, caching, background jobs, and CI/CD<br>🌱 Deepening knowledge in System Design, Clean Architecture, and Cloud Infrastructure<br>🤝 Open to collaboration on interesting backend projects<br><br>
